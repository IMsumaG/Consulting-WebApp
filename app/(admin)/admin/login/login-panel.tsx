              ...
              <div className="grid gap-2">
                ...
                <div className="relative">
                  <input
                    ...
                    className="h-12 w-full rounded-2xl border border-white/10 bg-white/10 px-4 pr-12 text-white outline-none transition placeholder:text-white/30 focus:border-brand-green focus:ring-4 focus:ring-brand-green/20"
                  ...
                  <button
                    ...
                    className="absolute inset-y-0 right-0 flex items-center px-4 text-white/40 hover:text-white/80 transition"
